          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-20">
            ...
            <div>
              ...
              <ul className="space-y-4 text-zinc-400 text-sm">
                ...
                <li><Link href="/legal/confidentialite" className="hover:text-primary transition-colors">Confidentialité</Link></li>
                <li><Link href="/legal/cgv" className="hover:text-primary transition-colors">CGV</Link></li>
